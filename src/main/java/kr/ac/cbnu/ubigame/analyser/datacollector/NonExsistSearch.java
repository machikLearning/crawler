...
public class NonExsistSearch {
	/*NonExsistSearch의 main*/
	public static void journalInvestigate() {
		BufferedReader bufferedReader  = null;
		try {
		  bufferedReader = new BufferedReader(new FileReader("src/main/resource/nonexsist.txt"));
		...
		try {
			bufferedWriter = new BufferedWriter(new FileWriter("src/main/resource/idSearch.txt",true));
	...
	/*날짜를 포함하고 있는 element와 class,id 반환*/
	public static void DateInvestigate(Document doc, String str) {
		...
		try {
			fileWriter = new FileWriter("src/main/resource/idSearch.txt",true);
		} catch (IOException e) {
	...
	/*body를 포함하고 있는 element와 class, id반환*/
	...
	/* title을 포함하고 있는 element와 class,id 반환*/
