...
public class EconomyTalkNews extends AbsCrawler {

	public EconomyTalkNews(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "이코노미톡뉴스";
	}
	
	public EconomyTalkNews(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
