...
public class SejongPost extends AbsCrawler {

	public SejongPost(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "세종포스트";
	}
	
	public SejongPost(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
