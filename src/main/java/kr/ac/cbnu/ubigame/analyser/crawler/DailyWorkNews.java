...
public class DailyWorkNews extends AbsCrawler {

	public DailyWorkNews(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "매일노동뉴스";
	}
	
	public DailyWorkNews(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
