...
public class SisaWeek extends AbsCrawler {

	public SisaWeek(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "시사위크";
	}
	
	public SisaWeek(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
