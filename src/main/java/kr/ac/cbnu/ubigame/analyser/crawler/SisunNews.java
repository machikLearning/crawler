...
public class SisunNews extends AbsCrawler {

	public SisunNews(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "시선뉴스";
	}
	
	public SisunNews(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
