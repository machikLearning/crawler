...
public class SundaySisa extends AbsCrawler {

	public SundaySisa(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "일요시사";
	}
	
	public SundaySisa(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
