...
public class SundaySeoul extends AbsCrawler {

	public SundaySeoul(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "일요서울";
	}
	
	public SundaySeoul(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
