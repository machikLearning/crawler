...
public class UlsanEverydayNews extends AbsCrawler {

	public UlsanEverydayNews(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "울산매일신문";
	}
	
	public UlsanEverydayNews(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
