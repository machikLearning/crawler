...
public class Rapportian extends AbsCrawler {

	public Rapportian(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "라포르시안";
	}
	
	public Rapportian(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
