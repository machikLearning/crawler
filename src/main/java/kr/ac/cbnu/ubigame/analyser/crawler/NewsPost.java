...
public class NewsPost extends AbsCrawler {

	public NewsPost(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "뉴스포스트";
	}
	
	public NewsPost(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
