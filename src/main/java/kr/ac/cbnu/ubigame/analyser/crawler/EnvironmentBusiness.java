...
public class EnvironmentBusiness extends AbsCrawler {

	public EnvironmentBusiness(String targetURL) throws IOException {
		super(targetURL);
		// TODO Auto-generated constructor stub
		this.journal = "환경비즈니스";
	}
	
	public EnvironmentBusiness(String url, String searchword, Date finalDate) throws IOException {
		// TODO Auto-generated constructor stub
